            ...
            <div class="row">
                ...
                <section class="main-content clearfix">
                    ...
                    <h2 class="marg">Education Loan</h2>
                                    <form name=cancel method=POST action="DeleteEducationLoan.jsp">
<%
try
{
    ...
    Connection connection = null; 
  	...
  	String QueryString = "Select id,BankName,Rate,EMI,ProcessingFee,MinLoanAmount,MaxLoanAmount,Link from education_loan";
  	...
  	{
  		%><h2>There are no education loans to show!</h2><% 
  	}
}
catch(Exception e)
{
