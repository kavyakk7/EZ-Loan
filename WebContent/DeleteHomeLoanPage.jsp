        ...
        <div class="global">
            <div class="row">
                ...
                <section class="main-content clearfix">
                    ...
                    <h2 class="marg">Home Loan</h2>
                                    <form name=cancel method=POST action="DeleteHomeLoan.jsp">
<%
try
{
    ...
    Connection connection = null; 
  	...
  	String QueryString = "Select id,BankName,Rate,EMI,ProcessingFee,MinLoanAmount,MaxLoanAmount,Link from home_loan";
  	...
  	{
  		%><h2>There are no home loans to show!</h2><% 
  	}
}
catch(Exception e)
{
