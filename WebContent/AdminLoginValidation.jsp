                ...
                <section class="main-content clearfix">
                    <article class="col-lg-3 col-md-6 col-sm-6">
                        <div class="thumb-pad1">
                            <div class="thumbnail">
                                <div class="caption">
                                    <p class="title"><a href="AddPersonalLoan.jsp">Add a new Personal loan</a></p>
                                    <p class="title"><a href="DeletePersonalLoan.jsp">Delete a Personal loan</a></p>
...
try 
{
	...
	String QueryString = "Select userid from admin where userid='"+user+"' and password='"+password+"'";
