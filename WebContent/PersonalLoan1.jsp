                ...
                <section class="main-content clearfix">
                    <article class="col-lg-4 col-md-6 col-sm-6 who-box maxheight"> 
                        <h2 class="marg">Personal Loan</h2>
                                <form name=ploan action="PersonalLoan1.jsp" method=POST>
                                <% 
...
try
{
    ...
    Connection connection = null; 
  	...
  	String QueryString = "Select BankName, Rate, EMI, ProcessingFee, Link from personal_loan where "+loan+" Between MinLoanAmount and MaxLoanAmount";
  	...
  	{
  		%><h2>No personal loans that meet your requirement!</h2>
  		<% 
  	}
}
catch(Exception e)
