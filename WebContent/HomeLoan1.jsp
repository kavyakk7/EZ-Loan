...
try
{
    ...
    Connection connection = null; 
  	...
  	String QueryString = "Select BankName, Rate, EMI, ProcessingFee, Link from home_loan where "+loan+" Between MinLoanAmount and MaxLoanAmount";
  	...
  	{
  		%><h2>No Home loans that meet your requirement!</h2>
  		<% 
  	}
}
catch(Exception e)
