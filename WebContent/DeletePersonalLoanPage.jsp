        ...
        <div class="global">
            <div class="row">
                ...
                <section class="main-content clearfix">
                    ...
                    <h2 class="marg">Personal Loan</h2>
                                    <form name=cancel method=POST action="DeletePersonalLoan.jsp">
<%
try
{
    ...
    Connection connection = null; 
  	...
  	String QueryString = "Select id,BankName,Rate,EMI,ProcessingFee,MinLoanAmount,MaxLoanAmount,Link from personal_loan";
  	...
  	if(rs!=null)
  	{
	    ...
	    <tbody>
  		...
  		%>
  		<tr>
  			<td><input type=checkbox name=id value='<%=rs.getString(1)%>'></td>
  	...
  	{
  		%><h2>There are no personal loans to show!</h2><% 
  	}
}
catch(Exception e)
{
